class PageMenu extends HTMLElement {
    ...
    render() {
        ...
        this.menuItems.forEach(menuItem => {
            ...
            menuElements.append(itemElement);
          
            this.createSubmenu(itemElement, menuItem)
        });
    ...
    createSubmenu(listElement, menuItem){

        if (menuItem.children) {
            
            let menuElements = document.createElement('ul');
            menuElements.classList.add('menu-admin-elemento');
            listElement.append(menuElements);
            ...
            menuItem.children.forEach( element => {
                ...
                linkElement.href =  element.customUrl;
                itemElement.append(linkElement);

                this.createSubmenu(itemElement, element);
            })
        }
    }
}
